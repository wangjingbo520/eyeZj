...
public class DropEditText extends FrameLayout implements View.OnClickListener, OnItemClickListener {
    ...
    private INormalChangeCallback changeCallback;
    ...
    public void setAdapter(BaseAdapter adapter) {
        ...
        mPopup = new PopupWindow(mPopView, JayUtils.dip2px(context, 200), LinearLayout.LayoutParams.WRAP_CONTENT);
    ...
    public void setDropviewImageClickCallBack(INormalChangeCallback callBack) {
    ...
    public void showPopList() {
        if (mPopup != null && listAdapter != null && listAdapter.getCount() > 0) {
